...
from src.commands import init_db as init_db_command
from src.models import User, Movie, Comment
from src.admin_views.base import SecureModelView
from src.admin_views.movie import MovieView
from flask_admin.menu import MenuLink
from src.models.comment import Comment
from src.admin_views.comment import CommentView
...
def register_extensions(app):
    ...
    admin.index_view = SecureIndexView()
    admin.init_app(app)
